...
/*
[class, QueryRoleModelPagedQueryResult],[interface, IQueryRoleModelPagedQueryResult],[schema, ZQueryRoleModelPagedQueryResult],[definition, {
        "type": "object",
        "properties": {
          "rows": {
            "type": "array",
            "items": {
              "$ref": "#/components/schemas/GreenOnion.Common.Models.QueryRoleModel"
            },
