...
import { QueryUserActionLogModelFilter } from "./QueryUserActionLogModelFilter";
import type { IQueryUserActionLogModelFilter } from "./IQueryUserActionLogModelFilter";
import { QueryUserActionLogModelOrderBy } from "./QueryUserActionLogModelOrderBy";
...
export class QueryUserActionLogModelSearchQuery implements IQueryUserActionLogModelSearchQuery {
    ...
    constructor(data?: IQueryUserActionLogModelSearchQuery) {
        if (data) {
    ...
    init(_data?: Partial<IQueryUserActionLogModelSearchQuery>) {
        if (_data) {
    ...
    static fromJS(data: Partial<IQueryUserActionLogModelSearchQuery>): IQueryUserActionLogModelSearchQuery {
        data = typeof data === 'object' ? data : {};
        const result = new QueryUserActionLogModelSearchQuery();
        result.init(data);
        return result;
    }
