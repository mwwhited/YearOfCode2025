...
import { ZQueryUserActionLogModelPagedQueryResult } from "../Schema/ZQueryUserActionLogModelPagedQueryResult";
import { QueryUserActionLogModel } from "./QueryUserActionLogModel";
...
export class QueryUserActionLogModelPagedQueryResult implements IQueryUserActionLogModelPagedQueryResult {
    readonly $zod: typeof ZQueryUserActionLogModelPagedQueryResult = ZQueryUserActionLogModelPagedQueryResult;
    ...
    constructor(data?: IQueryUserActionLogModelPagedQueryResult) {
        if (data) {
    ...
    init(_data?: Partial<IQueryUserActionLogModelPagedQueryResult>) {
        if (_data) {
            if (Array.isArray(_data["rows"])) {
                (<any>this).rows = [] as any;
                for (let item of _data["rows"])
                    (<any>this).rows!.push(QueryUserActionLogModel.fromJS(item));
            }
    ...
    static fromJS(data: Partial<IQueryUserActionLogModelPagedQueryResult>): IQueryUserActionLogModelPagedQueryResult {
        data = typeof data === 'object' ? data : {};
        const result = new QueryUserActionLogModelPagedQueryResult();
        result.init(data);
        return result;
    }
