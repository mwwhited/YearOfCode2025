...
import { QuerySubCategoryModelFilter } from "./QuerySubCategoryModelFilter";
import type { IQuerySubCategoryModelFilter } from "./IQuerySubCategoryModelFilter";
import { QuerySubCategoryModelOrderBy } from "./QuerySubCategoryModelOrderBy";
...
export class QuerySubCategoryModelSearchQuery implements IQuerySubCategoryModelSearchQuery {
    ...
    searchTerm?: string | undefined;/***Searched Properties:** SubCategoryName; SubCategoryCode; IsActive; CreatedBy; UpdatedBy*/
    filter?: IQuerySubCategoryModelFilter | undefined;
    orderBy?: IQuerySubCategoryModelOrderBy | undefined;

    constructor(data?: IQuerySubCategoryModelSearchQuery) {
        if (data) {
    ...
    init(_data?: Partial<IQuerySubCategoryModelSearchQuery>) {
        if (_data) {
    ...
    static fromJS(data: Partial<IQuerySubCategoryModelSearchQuery>): IQuerySubCategoryModelSearchQuery {
        data = typeof data === 'object' ? data : {};
        const result = new QuerySubCategoryModelSearchQuery();
        result.init(data);
        return result;
    }
