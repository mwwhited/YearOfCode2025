...
export const ZQueryProductModelOrderBy: z.ZodType<IQueryProductModelOrderBy> = z.object({
    productId: z.string(),
    name: z.string(),
...
/*
[class, QueryProductModelOrderBy],[interface, IQueryProductModelOrderBy],[schema, ZQueryProductModelOrderBy],[definition, {
        "type": "object",
        "properties": {
          "productId": {
