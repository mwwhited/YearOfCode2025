...
/*
[class, QueryIocCategoryModelPagedQueryResult],[interface, IQueryIocCategoryModelPagedQueryResult],[schema, ZQueryIocCategoryModelPagedQueryResult],[definition, {
        "type": "object",
        "properties": {
          "rows": {
            "type": "array",
            "items": {
              "$ref": "#/components/schemas/GreenOnion.Common.Models.QueryIocCategoryModel"
            },
