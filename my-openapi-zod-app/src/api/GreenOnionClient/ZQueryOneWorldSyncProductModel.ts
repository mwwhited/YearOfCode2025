...
export const ZQueryOneWorldSyncProductModel: z.ZodType<IQueryOneWorldSyncProductModel> = z.object({
    productId: z.string(),
    name: z.string(),
...
/*
[class, QueryOneWorldSyncProductModel],[interface, IQueryOneWorldSyncProductModel],[schema, ZQueryOneWorldSyncProductModel],[definition, {
        "type": "object",
        "properties": {
          "productId": {
            "type": "integer",
            "format": "int64",
            "nullable": true,
            "x-navigation-target": "GreenOnion.Common.Models.QueryProductModel"
          },
          "name": {
            "type": "string",
            "nullable": true
