...
/*
[class, QuerySchoolDistrictModelPagedQueryResult],[interface, IQuerySchoolDistrictModelPagedQueryResult],[schema, ZQuerySchoolDistrictModelPagedQueryResult],[definition, {
        "type": "object",
        "properties": {
          "rows": {
            "type": "array",
            "items": {
              "$ref": "#/components/schemas/GreenOnion.Common.Models.QuerySchoolDistrictModel"
            },
