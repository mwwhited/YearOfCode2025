...
export const ZQueryStateModelPagedQueryResult: z.ZodType<IQueryStateModelPagedQueryResult> = z.object({
    rows: z.string(),
    messages: z.string(),
...
/*
[class, QueryStateModelPagedQueryResult],[interface, IQueryStateModelPagedQueryResult],[schema, ZQueryStateModelPagedQueryResult],[definition, {
        "type": "object",
        "properties": {
          "rows": {
            "type": "array",
            "items": {
              "$ref": "#/components/schemas/GreenOnion.Common.Models.QueryStateModel"
            },
