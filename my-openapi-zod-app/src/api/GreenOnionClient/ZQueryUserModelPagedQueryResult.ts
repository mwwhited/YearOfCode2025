...
/*
[class, QueryUserModelPagedQueryResult],[interface, IQueryUserModelPagedQueryResult],[schema, ZQueryUserModelPagedQueryResult],[definition, {
        "type": "object",
        "properties": {
          "rows": {
            "type": "array",
            "items": {
              "$ref": "#/components/schemas/GreenOnion.Common.Models.QueryUserModel"
            },
