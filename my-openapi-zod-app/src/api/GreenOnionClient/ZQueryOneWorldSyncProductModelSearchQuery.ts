...
/*
[class, QueryOneWorldSyncProductModelSearchQuery],[interface, IQueryOneWorldSyncProductModelSearchQuery],[schema, ZQueryOneWorldSyncProductModelSearchQuery],[definition, {
        "type": "object",
        "properties": {
          "currentPage": {
            "type": "integer",
          ...
          "filter": {
            "$ref": "#/components/schemas/GreenOnion.Common.Models.QueryOneWorldSyncProductModelFilter"
          },
          "orderBy": {
            "$ref": "#/components/schemas/GreenOnion.Common.Models.QueryOneWorldSyncProductModelOrderBy"
          }
        },
