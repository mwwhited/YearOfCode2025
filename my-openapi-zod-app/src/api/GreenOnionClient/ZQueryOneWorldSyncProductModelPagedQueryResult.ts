...
export const ZQueryOneWorldSyncProductModelPagedQueryResult = z.object({
    rows:zARRAY!!!.describe("Gets the collection of items in the result."),
    messages:zARRAY!!!.describe("Gets or sets the collection of result messages associated with the query result."),
