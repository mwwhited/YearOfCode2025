...
/*
[class, QueryOneWorldSyncProductModelPagedQueryResult],[interface, IQueryOneWorldSyncProductModelPagedQueryResult],[schema, ZQueryOneWorldSyncProductModelPagedQueryResult],[definition, {
        "type": "object",
        "properties": {
          "rows": {
            "type": "array",
            "items": {
              "$ref": "#/components/schemas/GreenOnion.Common.Models.QueryOneWorldSyncProductModel"
            },
