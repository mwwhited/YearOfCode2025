...
/*
[class, QueryRoleModelSearchQuery],[interface, IQueryRoleModelSearchQuery],[schema, ZQueryRoleModelSearchQuery],[definition, {
        "type": "object",
        "properties": {
          "currentPage": {
            "type": "integer",
          ...
          "searchTerm": {
            "type": "string",
            "description": "**Searched Properties:** RoleName; CreatedBy; UpdatedBy",
            "nullable": true
          },
          "filter": {
            "$ref": "#/components/schemas/GreenOnion.Common.Models.QueryRoleModelFilter"
          },
          "orderBy": {
            "$ref": "#/components/schemas/GreenOnion.Common.Models.QueryRoleModelOrderBy"
          }
        },
