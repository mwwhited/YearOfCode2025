...
export const ZQueryUserActionLogModelPagedQueryResult: z.ZodType<IQueryUserActionLogModelPagedQueryResult> = z.object({
    rows: z.string(),
    messages: z.string(),
...
/*
[class, QueryUserActionLogModelPagedQueryResult],[interface, IQueryUserActionLogModelPagedQueryResult],[schema, ZQueryUserActionLogModelPagedQueryResult],[definition, {
        "type": "object",
        "properties": {
          "rows": {
            "type": "array",
            "items": {
              "$ref": "#/components/schemas/GreenOnion.Common.Models.QueryUserActionLogModel"
            },
