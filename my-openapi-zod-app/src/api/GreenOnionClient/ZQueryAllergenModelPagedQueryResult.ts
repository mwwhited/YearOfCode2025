...
/*
[class, QueryAllergenModelPagedQueryResult],[interface, IQueryAllergenModelPagedQueryResult],[schema, ZQueryAllergenModelPagedQueryResult],[definition, {
        "type": "object",
        "properties": {
          "rows": {
            "type": "array",
            "items": {
              "$ref": "#/components/schemas/GreenOnion.Common.Models.QueryAllergenModel"
            },
