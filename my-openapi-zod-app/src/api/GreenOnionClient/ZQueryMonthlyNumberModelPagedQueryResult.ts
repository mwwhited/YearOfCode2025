...
/*
[class, QueryMonthlyNumberModelPagedQueryResult],[interface, IQueryMonthlyNumberModelPagedQueryResult],[schema, ZQueryMonthlyNumberModelPagedQueryResult],[definition, {
        "type": "object",
        "properties": {
          "rows": {
            "type": "array",
            "items": {
              "$ref": "#/components/schemas/GreenOnion.Common.Models.QueryMonthlyNumberModel"
            },
