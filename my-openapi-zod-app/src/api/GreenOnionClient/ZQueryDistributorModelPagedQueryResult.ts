...
export const ZQueryDistributorModelPagedQueryResult: z.ZodType<IQueryDistributorModelPagedQueryResult> = z.object({
    rows: z.string(),
    messages: z.string(),
...
/*
[class, QueryDistributorModelPagedQueryResult],[interface, IQueryDistributorModelPagedQueryResult],[schema, ZQueryDistributorModelPagedQueryResult],[definition, {
        "type": "object",
        "properties": {
          "rows": {
            "type": "array",
            "items": {
              "$ref": "#/components/schemas/GreenOnion.Common.Models.QueryDistributorModel"
            },
