...
/*
[class, QueryStorageTypeModelPagedQueryResult],[interface, IQueryStorageTypeModelPagedQueryResult],[schema, ZQueryStorageTypeModelPagedQueryResult],[definition, {
        "type": "object",
        "properties": {
          "rows": {
            "type": "array",
            "items": {
              "$ref": "#/components/schemas/GreenOnion.Common.Models.QueryStorageTypeModel"
            },
