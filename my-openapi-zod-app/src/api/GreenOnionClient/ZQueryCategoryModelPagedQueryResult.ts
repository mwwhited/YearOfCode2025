...
export const ZQueryCategoryModelPagedQueryResult: z.ZodType<IQueryCategoryModelPagedQueryResult> = z.object({
    rows: z.string(),
    messages: z.string(),
...
/*
[class, QueryCategoryModelPagedQueryResult],[interface, IQueryCategoryModelPagedQueryResult],[schema, ZQueryCategoryModelPagedQueryResult],[definition, {
        "type": "object",
        "properties": {
          "rows": {
            "type": "array",
            "items": {
              "$ref": "#/components/schemas/GreenOnion.Common.Models.QueryCategoryModel"
            },
