...
export const ZQueryProductModelFilter: z.ZodType<IQueryProductModelFilter> = z.object({
    productId: z.string(),
    name: z.string(),
...
/*
[class, QueryProductModelFilter],[interface, IQueryProductModelFilter],[schema, ZQueryProductModelFilter],[definition, {
        "type": "object",
        "properties": {
          "productId": {
