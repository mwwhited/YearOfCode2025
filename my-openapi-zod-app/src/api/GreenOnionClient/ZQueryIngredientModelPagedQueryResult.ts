...
export const ZQueryIngredientModelPagedQueryResult: z.ZodType<IQueryIngredientModelPagedQueryResult> = z.object({
    rows: z.string(),
    messages: z.string(),
...
/*
[class, QueryIngredientModelPagedQueryResult],[interface, IQueryIngredientModelPagedQueryResult],[schema, ZQueryIngredientModelPagedQueryResult],[definition, {
        "type": "object",
        "properties": {
          "rows": {
            "type": "array",
            "items": {
              "$ref": "#/components/schemas/GreenOnion.Common.Models.QueryIngredientModel"
            },
