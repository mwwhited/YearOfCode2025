...
export class QuerySchoolDistrictModelPagedQueryResult implements IQuerySchoolDistrictModelPagedQueryResult {
    readonly $schema: typeof ZQuerySchoolDistrictModelPagedQueryResult = ZQuerySchoolDistrictModelPagedQueryResult;
    ...
    constructor(data?: IQuerySchoolDistrictModelPagedQueryResult) {
        if (data) {
    ...
    init(_data?: Partial<IQuerySchoolDistrictModelPagedQueryResult>) {
        if (_data) {
            if (Array.isArray(_data["rows"])) {
                (<any>this).rows = [] as any;
                for (let item of _data["rows"])
                    (<any>this).rows!.push(QuerySchoolDistrictModel.fromJS(item));
            }
    ...
    static fromJS(data: Partial<IQuerySchoolDistrictModelPagedQueryResult>): IQuerySchoolDistrictModelPagedQueryResult {
        data = typeof data === 'object' ? data : {};
        const result = new QuerySchoolDistrictModelPagedQueryResult();
        result.init(data);
        return result;
    }
