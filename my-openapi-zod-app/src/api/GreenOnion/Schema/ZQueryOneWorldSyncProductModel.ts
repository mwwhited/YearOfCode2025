...
const ZQueryOneWorldSyncProductModel = z.object({
    productId: z.number().int().meta({'x-navigation-target':'GreenOnion.Common.Models.QueryProductModel',}).nullish(),  
    ...
    oneWorldSyncProductId: z.number().int().meta({'x-navigation-key':'True',}).nullish(),  
