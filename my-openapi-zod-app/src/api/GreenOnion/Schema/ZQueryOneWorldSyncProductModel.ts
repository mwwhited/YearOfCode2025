...
const ZQueryOneWorldSyncProductModel = z.object({
    productId: z.number().int().nullish().meta({'x-navigation-target':'GreenOnion.Common.Models.QueryProductModel',}),  
    ...
    oneWorldSyncProductId: z.number().int().nullish().meta({'x-navigation-key':'True',}),  
