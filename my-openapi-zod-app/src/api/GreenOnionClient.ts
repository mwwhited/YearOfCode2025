...
const GreenOnion_Common_Models_QueryProductModelPagedQueryResult = z
  ...
  .partial();
const GreenOnion_Common_Models_SaveProductModel = z
  .object({
    productId: z.number().int().nullable(),
    productName: z.string().nullable(),
    gtin: z.string().nullable(),
    ...
    brandName: z.string().nullable(),
    description: z.string().nullable(),
    allergenKeywords: z.string().nullable(),
    vendor: z.string().nullable(),
    manufacturerId: z.number().int().nullable(),
    storageTypeId: z.number().int().nullable(),
    productLabelPdfUrl: z.string().nullable(),
    manufacturerProductCode: z.string().nullable(),
    isActive: z.boolean().nullable(),
    nutritionalInformation:
      GreenOnion_Common_Models_NutritionalInformationModel,
  })
...
export const schemas = {
  ...
  GreenOnion_Common_Models_SaveProductModel,
    ...
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: GreenOnion_Common_Models_SaveProductModel,
      },
    ],
    response: GreenOnion_Common_Models_QueryProductModel,
  },
